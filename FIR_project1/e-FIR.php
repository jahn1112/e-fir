                        ...
                        <div class="r1" style="display:none;">
                            <div class="r2">
                                <div class="r3">
                                    ...
                                    <span class="r5">*</span>
                                    <input type="date" class="r6" id="Date From" aria-describedby="emailHelp" name="Date_from">
                                </div>
                            </div>
                            <div class="r2">
                                <div class="r3">
                        ...
                        <div class="r1">
                            <div class="r2">
                                <div class="r3">
                                    ...
                                    <span class="r5">*</span>
                                    <input type="date" class="r6" id="exampleInputEmail1" aria-describedby="emailHelp" required name="Date_to">
                                </div>
                            </div>
                            <div class="r2">
                                <div class="r3">
