        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="card welcome-box">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="image">
                                    <img src="img/user.png" class="img-circle elevation-2 border" alt="User" height="60px" width="60px" style="border-color: var(--accent) !important;">
                                </div>
                                <div class="ml-4">
                                    <h4 class="mb-1" style="color: #fff;">Hello, <b><?php echo $_SESSION["user"]; ?></b></h4>
                                    <p class="mb-0 text-muted" style="letter-spacing: 0.5px;">Welcome to the Gujarat Police Administrative Portal</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- small boxes -->                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box" style="background: linear-gradient(135deg, #10b981, #059669);">
                                <div class="inner">
                                    <h3> <?php rpt_missing_person($con)?> </h3>
                    ...
                    <div class="card" style="background: linear-gradient(135deg, rgba(5, 28, 160, 0.4), rgba(5, 28, 160, 0.1)); border: 1px solid var(--glass-border);">
                        <div class="card-body">
                            <h2 class="text-center font-weight-bold mb-4" style="color: var(--accent); letter-spacing: 2px;">GOVERNMENT OF GUJARAT</h2>
                            <div class="separator mb-4" style="height: 2px; background: linear-gradient(to right, transparent, var(--accent), transparent);"></div>
                            <h3 class="mb-3">Official Administrative Portal</h3>
                            <p class="lead">&nbsp; This site is strictly for official use only. Unauthorized access is prohibited.</p>
                            <div class="alert mt-4" style="background: rgba(239, 68, 68, 0.1); border-left: 4px solid var(--danger); border-radius: 8px;">
                                <p class="mb-0"><b style="color: var(--danger);">EDUCATIONAL DISCLAIMER:</b> This platform is developed for educational purposes. All digital assets belonging to Gujarat Police are handled with respect and are not used for commercial gain.</p>
                            </div>
                        </div>
                    </div>
